...
export default function TemplateLivePreview({ id, colors, logoDataUrl, backgroundDataUrl, animationStyle = "fade" }: Props) {
  ...
  const baseClass = `rounded-xl border border-border bg-card p-6 relative overflow-hidden ${animClass}`;
    ...
    return (
      <div className={baseClass} style={bgStyle}>
        <div className="relative space-y-4">
          <Header title="Coffee Lovers" subtitle="Collect 10 stamps" primary={primary} />
          <Logo />
  ...
  if (id === "circular") {
    return (
      <div className={baseClass} style={bgStyle}>
        <div className="relative space-y-4">
          <Header title="Tea Club" subtitle="Buy 8 get 1 free" primary={primary} />
          <Logo />
  ...
  if (id === "progress") {
    return (
      <div className={baseClass} style={bgStyle}>
        <div className="relative space-y-4">
          <Header title="Smoothie Streak" subtitle="Reach 100% to redeem" primary={primary} />
          <Logo />
  ...
  if (id === "tiered") {
    return (
      <div className={baseClass} style={bgStyle}>
        <div className="relative space-y-4">
          <Header title="Tiered Tastes" subtitle="Bronze → Silver → Gold" primary={primary} />
          <Logo />
  ...
  if (id === "pathway") {
    return (
      <div className={baseClass} style={bgStyle}>
        <div className="relative space-y-4">
          <Header title="Pathway Perks" subtitle="Follow the path to rewards" primary={primary} />
          <Logo />
  ...
  if (id === "honeycomb") {
    return (
      <div className={baseClass} style={bgStyle}>
        <div className="relative space-y-4">
          <Header title="Honey Rewards" subtitle="Fill the comb" primary={primary} />
          <Logo />
  ...
  if (id === "star") {
    return (
      <div className={baseClass} style={bgStyle}>
        <div className="relative space-y-4">
          <Header title="Star Seekers" subtitle="Collect stars" primary={primary} />
          <Logo />
          <div className="flex flex-wrap gap-2">
            {Array.from({ length: 10 }).map((_, i) => (
  ...
  if (id === "barcode") {
    return (
      <div className={baseClass} style={bgStyle}>
        <div className="relative space-y-4">
          <Header title="Scan & Unlock" subtitle="Scan QR to progress" primary={primary} />
          <Logo />
  ...
  if (id === "puzzle") {
    return (
      <div className={baseClass} style={bgStyle}>
        <div className="relative space-y-4">
          <Header title="Puzzle Perks" subtitle="Complete the picture" primary={primary} />
          <Logo />
  ...
  return (
    <div className={baseClass} style={bgStyle}>
      <div className="relative space-y-4">
        <Header title="Minimal Moments" subtitle="Simple progress" primary={primary} />
        <Logo />
...
function Header({ title, subtitle, primary }: { title: string; subtitle: string; primary: string }) {
  return (
...
function Actions({ primary }: { primary: string }) {
  return (
    <div className="flex gap-2">
      <button className="rounded-md px-4 py-2 text-primary-foreground" style={{ background: primary }}>Collect</button>
